...
client.on("ready", () => {
    var guild;
    while (!guild)
        guild = client.guilds.get("599899467558289419");
...
client.on("guildMemberAdd", (member) => {
    let channel = member.guild.channels.get("613481206167896065");
    if (!channel) {
...
client.on('ready', () => {// افنت التشغيل 
  ...
  }, 4000);// وقت الريمبو لا تغيرة لانه الوقت المسموح للتغيير
})	
...
===================== **اوامر عامة** =====================
!!id ➾ معلومات عن حسابك
!!profile ➾ عرض البروفايل الخاص بك
